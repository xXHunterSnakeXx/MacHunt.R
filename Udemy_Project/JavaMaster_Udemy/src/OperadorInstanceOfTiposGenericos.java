public class OperadorInstanceOfTiposGenericos {
    public static void main(String[] args) {
        ...
        //En la clase "OperadorInstanceOf" No permitia evaluar "true o false" para {texto instanceof Integer}
        //por la declaracion de variable texto, antes era String texto, en la declaracion actual quedo como Object
        ...
        //Un tipo de dato Double tiene una precision de 15 digitos decimales
        b1 = decimal instanceof Double;
        System.out.println("decimal es del tipo Double = " + b1);

        //Un tipo de dato Float tiene una precision de 7 digitos decimales
